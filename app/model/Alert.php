...
class Alert extends \App\EditArea {
    public function __construct() {
        ...
        $this->fields = [
            ...
            "pdf" => new \App\File(["accept" => ["pdf"], "maxSize" => 500000, "public" => false]),
            "tag" => new \App\MultipleForeignKeys("Model\Tag", ["column" => "nom"]),
            "cle" => new \App\ForeignKey("Model\Tag", ["column" => "nom"]),
